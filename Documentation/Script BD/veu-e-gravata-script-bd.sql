CREATE TABLE `TB_CASAL`(
    `ID_CASAL` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `TB_CONJUGE`(
    `ID_CONJUGE` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `TB_PRODUTO_CASAL`(
    `ID_PRODUTO_CASAL` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `DH_INCLUSAO` DATETIME NOT NULL,
    `FK_PRODUTO` INT NOT NULL,
    `FK_CASAL` INT NOT NULL,
    `TG_RESERVADO` TINYINT(1) NOT NULL,
